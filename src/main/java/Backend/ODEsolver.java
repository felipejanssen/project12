...
public class ODEsolver {
    ...
    // Euler's Solver
    /**
     * Estimates the results of given ODE using Euler's Solver with following parameters
     *
    ...
    public double[] eulerSolve(int steps, double time0, double[] initialState, double h) {
